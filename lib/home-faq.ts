...
export const homeFaqs = [
  ...
  // 2026-09-14追記: AIの引用に耐える「一問一答＋数字＋出典」。数字は当社ブログの一次集計と同じ値のみ使う。
  {
    q: '雨漏り修理の費用はいくらくらいですか？',
    a: '当社の写真AI診断で概算が出た56件（2026年1月28日〜6月10日）では、中央値が15万〜45万円、最も多い帯は上限20万〜50万円の31件でした。応急処置だけなら3万円が22件・5万円が20件です。写真からの推定で、現地で原因を特定した見積ではありません。',
    source: { label: '出典: 雨漏り修理の費用はいくら？写真診断56件の概算', href: '/blog/amamori-shuuri-hiyou-souba' },
  },
  {
    q: '雨漏りの原因で多い場所はどこですか？',
    a: '写真AI診断を完了した65件（2026年1月〜6月）で、写真から推定された被害箇所は室内の天井が40件、屋根裏・天井裏が26件、軒天が26件、屋根の表面が23件でした（重複あり）。天井にしみがある家は、屋根裏と軒天を一緒に見ると入口が見つかりやすい、という数字です。',
    source: { label: '出典: 写真診断65件でいちばん多かった雨漏りの出どころ', href: '/blog/shashin-shindan-65ken-higai-kasho' },
  },
] as const;
